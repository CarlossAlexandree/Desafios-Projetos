...
Este repositório documenta a especificação técnica, a engenharia de prompts e o fluxo de interação lógica configurados para o **Agente 01** e o **Agente 02**. O objetivo deste documento é servir como um guia de referência detalhado, consolidando as instruções operacionais de cada agente e as respectivas respostas estruturadas para garantir a reprodutibilidade e a consistência do sistema.
